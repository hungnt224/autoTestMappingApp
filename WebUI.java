...
public class WebUI {
    ...
    public static void waitForVisibility(By by){
        try {
            ...
            //ManagerLog.error("Timeout waiting for the element Visible. " + by.toString());
        }
    }
    public static void waitForPresent(By by){
        try {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    ...
    public static void waitforAlert(){
        try {
           ...
           // ManagerLog.error("No have Alert" );
        }
    }
    public static void waittextToBePresentInElementValue(By by, String type){
        try {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            wait.until(ExpectedConditions.textToBePresentInElementValue(by,type));
        } catch (Throwable error) {
            //ManagerLog.error("Timeout waiting for the element Visible. " );
        }
    }
    ...
    private static List<WebElement> getWebElements(By by) {
    ...
    public static void moveMouseToCenter() {
        ...
        // Tạo Actions
        Actions action = new Actions(driver);
        action.moveByOffset((int) width / 2, (int) height / 2).perform();
    }
    ...
    public static void waitForPageLoaded() {
        ...
        if (!jsReady) {
            ...
            try {
                ...
                Assert.fail("Timeout waiting for page load (Javascript). (" + 10 + "s)");
            }
        }
    }
